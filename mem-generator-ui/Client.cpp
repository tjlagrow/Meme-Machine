...
int main()
{
    ...
    */
    ...
    int client;
    int portNum = 1101; // NOTE that the port number is same for both client and server
    bool isExit = false;
    int bufsize = 1024;
    char buffer[bufsize];
    char* ip = "127.0.0.1";
    ...
    */
    ...
    cout << "\n\n=> Enter * at the end of the message to sent" << endl;
    cout << "=> Enter # at the end of the message to terminate connection\n" << endl;
